...
export default function HeroContent() {
  return (
    <div className="flex mt-20 flex-col-reverse md:flex-row items-center gap-10">
      <div className="space-y-6">
        ...
        <p className="text-3xl text-gray-700 max-w-2xl">
          Empowering enterprises with ultra-low latency infrastructure, global
          5G coverage, and secure communication channels that never sleep
        </p>
